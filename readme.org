...
chapter 0 = kill math basics (study linear algebra, statistics+probability+naive bayes+stochastic gradient descent, real analysis, trig)
chapter 1 = [AI, data visualization, simulation]
chapter 2 = Visualizing the Human Mind or Brain [NeuroScience, Spirituality, Math]
chapter 3 = world transforming mind = robots rebuild earth + genomics create arcology cities